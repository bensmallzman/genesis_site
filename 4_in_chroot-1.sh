...
cd ..
tar -xvf iana-etc-20220207.tar.gz && rm iana-etc-202207.tar.gz && cd iana-etc-202207
cp services protocols /etc

cd ..
cd glibc-2.35 && patch -Np1 -i ../glibc-2.35-fhs-1.patch && rm ../glibc-2.35-fhs-1.patch && cd build
